...
def compress(item_list=[], simCalculator=MinhashClusterSimilarity()):
...
for w in compressed_new_actors.items():
    if w[0] in excluded_actor_list:
        ...
        print w[0]
print 'Number of actors extracted: ', count

role_dict = RoleDictionary(similarityMeasure=MinhashClusterSimilarity())
simCalculator = MinhashClusterSimilarity()
count = 0
count_partial = 0;
